...
class AuthService {
  ...
  Future<Map<String, dynamic>> login(String email, String password) async {
    try {
      ...
      // Vérifier les identifiants de démonstration pour permettre la connexion même sans serveur
      if (email == 'gheya63@gmail.com' && password == '12345678') {
        print('Utilisation des identifiants de démonstration');
      ...
      try {
        ...
        // Si le serveur n'est pas accessible, utiliser les identifiants de démonstration
        if (email == 'gheya63@gmail.com' && password == '12345678') {
          print('Serveur inaccessible, utilisation des identifiants de démonstration');
